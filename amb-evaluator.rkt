...
(define (list->lazy-list l)
  (if (null? l)
      'nil
      (list 'cons (car l) (list->lazy-list (cdr l)))))
...
(define e (extend-environment '(a b c) '(1 2 3) the-empty-environment))
(define f (extend-environment '(d) '(4) e))
